...
global.owner = [
  ['967738512629', '『🄱🄾🅃 🄰🄻🄼🅄🅂🄰🄱🄸』', true],  // المالك الأول
  ['201145624848', '𝗦𝗔𝗬𝗘𝗗-𝗦𝗛𝗔𝗪𝗔𝗭𝗔', true]  // المالك الثاني
];


global.ownername = '『🄱🄾🅃 🄰🄻🄼🅄🅂🄰🄱🄸』';
global.ownernumber = '967738512629';
global.myid = '967738512629@s.whatsapp.net';
  
global.suittag = ['967738512629', '201145624848'];
global.prems = ['967738512629', '201145624848'];
...
global.titulowm2 = `『🄱🄾🅃 🄰🄻🄼🅄🅂🄰🄱🄸』`
global.igfg = '『🄱🄾🅃 🄰🄻🄼🅄🅂🄰🄱🄸』';
global.wait = '*「 ▓▓▓▓▓▒▒▒▒░░░ 」 صلي على النبي ي ياقلبي 🤖 ...*';
...
global.fcon = {key: {participant: '0@s.whatsapp.net', remoteJid: 'status@broadcast', fromMe: false, 'id': wm}, message: {'contactMessage': { 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid= '967738512629@s.whatsapp.net':'967738512629@s.whatsapp.net'\nitem1.X-ABLabel:Ponsel\nEND:VCARD` } }, 'participant': '0@s.whatsapp.net' };
global.fgif2 = {key: {participant: '0@s.whatsapp.net',  ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': '『🄱🄾🅃 🄰🄻🄼🅄🅂🄰🄱🄸』', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '『🄱🄾🅃 🄰🄻🄼🅄🅂🄰🄱🄸』', 'jpegThumbnail': false}}};
